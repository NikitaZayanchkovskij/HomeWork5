...
public class Main5_NamesFromFile {
    ...
    public static String getName(String filePath){
        ...
        /** Try catch для закрытия Buffered Reader. НО! Если будет ошибка из строчки 95 - некорректное
         * чтение файла, то в закрытие в это мы никогда не попадём!
         * А файл наш нужно закрыть, даже если произошла ошибка чтения.
         * Поэтому делаем след образом: смотри вкладку Main6_NamesFromFile.
         */
        try {
