...
public class Main9_NamesFromFile {
    public static void main(String[] args) {
        ...
        System.out.println("Заполненный список студентов: \n" + students);//Печатаем наших студентов.
      ...
      //мы делаем этот цикл. А если нам нужно что-то добавлять или удалять из списка - тогда for i.
      ...
      //StudentAgeComparator studentAgeComparator = new StudentAgeComparator(); - Можно было и так, вместо след. строчки.
        ...
        System.out.println("\nСтуденты по возрасту и оценке одновременно:");
        index = 0;
        for (Student filteredStudents2 : filteredStudents){
            System.out.print(filteredStudents2);
            index++;
        ...
        /** Ещё не вывели топ 10 в КАЖДОМ возрасте. Смотри вкладку Main10_NamesFromFile */
